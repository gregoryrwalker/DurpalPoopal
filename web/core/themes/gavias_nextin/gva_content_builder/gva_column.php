...
class element_gva_column{
         ...
         'key'    => 'gva_column',
          ...
          array(
            ...
            array(
               ...
               'options'    => array(
                  ''                 => 'Default',
                  'column-style-1'        => 'Style 1: Margin & Responsive',
                  'column-style-2'        => 'Style 2: Padding 100px & Responsive',
                  'column-style-3'        => 'Style 3: max-with 600px, float left, padding responsive',
                  'column-style-4'        => 'Style 4: Padding 80px & Responsive',
                  'column-border-light'   => 'Style 5: Border Light',
                  'column-absolute'       => 'Style 6: Position Absolute',
               )
            ),
		      array(
		        'id'      => 'el_class',
   ...
   ?>
		<div <?php if($id_column) print 'id="'.$id_column.'"' ?> class="gsc-column <?php print ( $style == 'column-absolute' ? 'gsc-column-absolute' : ' ' ) ?> <?php print $column_class; ?>" <?php echo(($column_style) ? 'style="'.$column_style.'"' : '');  ?>>
