...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <script src="<?php print (base_path() . drupal_get_path('theme', 'gavias_nextin')) ?>/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . drupal_get_path('theme', 'gavias_nextin')) ?>/vendor/jquery.ui.map.min.js"></script>
